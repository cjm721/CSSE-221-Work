...
public class FunctionObjectsExample {
	private static final String[] csseFaculty = new String[] { "Laxer",
		"Shillingford Wondem", "Boutell", "Hewner", "Chenoweth", "Wollowski",
		"Mellor", "Defoe", "Bohner", "Anderson", "Mutchler", "Mohan", "Taylor", "Rupakheti"};
	...
	public static void main(String[] args) {
		...
		// faculty ordered by most vowels in name
		final Comparator<String> byMostVowels = new MostVowelsComparator();
		Arrays.sort(csseFaculty, byMostVowels);
